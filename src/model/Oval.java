...
public class Oval extends AbstractShape {
  ...
  /**
   * Constructor for an Oval object. Sets the oval to default values which wont be changed
   * until the update() method is called on this object. By default, the center
   * is at {0,0}, it is not visible, and the color is black {0,0,0}.
  ...
  public void update(int time) {
    ...
    this.isVisible = master.getVisiblity(time);
  }
