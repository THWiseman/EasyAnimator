...
/**
 * This abstract class represents the qualities of a Shape as it changes over the course of an
 * animation, such as its color, size, and position.
 */
public abstract class AbstractPattern implements Pattern {

  List<LogNode> changeLog = new ArrayList<>();
  int earliestChangeFrame = 0;
  int latestChangeFrame = 0;
  Map<Integer, int[]> pattern;

  /**
   * Given start/end times and start/end values, figures out what the value of something would be
   * between those times.
   *
